...
def get_all_updates():
    get_updates("MissParisCrypto","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("Vaultbtw","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("BSCsuper1000X","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("V4Pixel","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("CryptoGemsNFT_","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("AnbroNFT","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("@CryptoXMad","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("Cointelegraph","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("Web3Wizard_","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("FrodlitNFT","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("iamnoahmiller","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("FrodlitNFT","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("minimalcsgo","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("0xSimxn","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("DegendsLabs","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)

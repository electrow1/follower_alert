...
def get_all_updates():
    get_updates("Karijelinek","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("CryptoGemsCom","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("BSCsuper1000X","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("cryptotokyobb","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("_snuppy08","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("cryptoarthur92","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("sofizamolo","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("GemsLadyBullish","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("GeorgiKose","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("papa_woody21","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("nftcody_3","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("city_crypto1","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("jackthepromoter","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("ShibaArmy2021","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
    get_updates("jeffersnmatos","sodiq.yusuf.a33@gmail.com")
    time.sleep(10)
